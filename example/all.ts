...
const m = new Main({
  ...
  pen: "writing",
  bgImg: bgImg,
  bgImgDrawCall(ctx:CanvasRenderingContext2D, img:any, main:Main) {
...
m.addPen("fangkuai", "./1.png", function(main:Main, penObj:any) {
...
}, function(main:Main, penObj:any, pos:POINT) {
  main.dropData.nowLine = new Main.STRUCT.Line(main.pen)
  main.dropData.nowLine.pushPoint(new Main.STRUCT.Point(pos.x, pos.y))
...
const redo = document.getElementById("redo") as HTMLElement
const getJson = document.getElementById("getJson") as HTMLElement
const downloadPng = document.getElementById("downloadPng") as HTMLElement
...
getJson.addEventListener("click", function() {
  const jsonStr = m.toJson()
  console.log(jsonStr)
  alert(jsonStr)
})
downloadPng.addEventListener("click", function() {
  const baseUrl = m.toPng()
